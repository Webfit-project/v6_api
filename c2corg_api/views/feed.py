...
def get_changes_of_feed(token_id, token_time, limit, extra_filter=None):
    ...
    # print('.............LANGUAGELANGUAGELANGUAGELANGUAGELANGUAGELANGUAGE......')
    # print(lang)
    # print('LOG LANGUAGE', lang)
    #
    # if lang is not None:
    #     query = query.filter(
    #         and_(DocumentChange.lang_ids is not None,
    #              DocumentChange.lang_ids.any_(lang)))
...
def create_personal_filter(user):
    ...
    # if user.feed_filter_lang_preferences:
